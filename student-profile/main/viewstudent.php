...
<head>
<title>
UiTM Student e-Profile System</title>
...
?>
<link href="../style.css" media="screen" rel="stylesheet" type="text/css" />
<center><h4><i class="icon-edit icon-large"></i> Student Profile</h4></center>
<hr>
...
<td style="padding: 10px;
				...
				background-color: #f4f4f4;
				text-align: center;
				color: #7d7d7d;"> <?php echo $row['admission_year']; ?></td>
</tr>
...
<td style="padding: 10px;
				...
				background-color: #f4f4f4;
				text-align: center;
				color: #7d7d7d;"> <?php echo $row['faculty']; ?></td>
</tr>
<tr>
<td> Course :  </td>
<td style="padding: 10px;
				...
				background-color: #f4f4f4;
				text-align: center;
				color: #7d7d7d;"> <?php echo $row['course']; ?></td>
</tr>
