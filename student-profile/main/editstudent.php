...
<span>Student ID: </span><input type="text" style="width:265px; height:30px;"  name="student_id" value="<?php echo $row['student_id']; ?>" readonly Required/><br>
...
<span>Admission Year </span><select name="admission_year" style="width:265px; height:30px; margin-left:-5px;" >
	<option><?php echo $row['admission_year']; ?></option>
	<option>2009</option>
	<option>2010</option>
	<option>2011</option>
	<option>2012</option>
...
<span>Faculty : </span><input type	="text" style="width:265px; height:30px;" value="<?php echo $row['faculty']; ?>" name="faculty" required /><br>

<span>Course : </span><textarea style="width:265px; height:50px;" name="course" ><?php echo $row['course']; ?> </textarea><br><br>

<span>Semester : </span><textarea style="width:265px; height:50px;" name="semester" ><?php echo $row['semester']; ?> </textarea><br><br>
