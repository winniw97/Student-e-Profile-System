...
<span>Faculty: </span><input type	="text" style="width:265px; height:30px;" name="faculty" required />
<br>

<span>Course: </span><input type	="text" style="width:265px; height:30px;" name="course" required /><br>

<span>Semester: </span><input type	="text" style="width:265px; height:30px;" name="semester" required /><br>

<span>Student Profile:</span><input type="file" style="width:265px; height:50px;" name="file" id="file" required ><br><br>
<div >
